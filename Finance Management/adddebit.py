...
def submit():
	...
	try:
		sql = "INSERT INTO  debit (name,value,reason,moment) VALUES (%s, %s, %s, %s)"
...
def run(): 
    ...
    l.pack()
    root.title("Add Debit Transaction")
    global e1
    global e2
    global e3
     
    Label(root, text="Add Debit", fg="black", font=(None, 24)).place(x=80, y=5)
